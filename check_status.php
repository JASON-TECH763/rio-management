        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Check Booking <span class="text-primary text-uppercase">Status</span></h1>
                </div><center>
                <div class="col-lg-4">
                        ...
                        <form method="POST" action="status_detail.php">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" name="check" type="submit">Check Status</button>
                                    </div>
                                </div>
                            </form>
                        </div>
