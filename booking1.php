                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="date" name="checkin_date" class="form-control" id="name" placeholder="Check-in Date" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d'); ?>" required>
                                            <label for="name">Check-in Date</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="date" class="form-control" name="checkout_date" min="<?php echo date('Y-m-d', strtotime('+1 day')); ?>" required>
                            ...
                            <option value="Mrs.">Mrs.</option>
                                    ...
                                    <div class="col-6">
                                        <div class="form-floating">
                                           <input type="text" class="form-control" id="retype" name="etype_email" placeholder="Enter Lastname"  required>
